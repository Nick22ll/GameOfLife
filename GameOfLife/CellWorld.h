...
/*
    This class represents the model in the MVC pattern which also mainly involves WorldViewer(the viewer) and TimerController(the controller).
    As the name suggests, the class represents the world of cells in which the Game Of Life takes place.
    The world is built thanks to the use of a positional matrix in which each cell(i,j) represents a cell that is capable of being born, dying and aging following the rules of the game.
*/
